...
# mode -- see src/llm.py). Model-proposed keywords are the least trustworthy signal
...
# Facet route (free-form path only -- see src/facets.py). Weighted at the category
...
class CatalogIndex:
    ...
    def retrieve(
        ...
        if facets:
            try:
                from src import facets as facets_module
